...
class MovieDetailPage6 : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_movie_detail_page6)
        ...
        movieUrl.setOnClickListener {
            var intent =
                Intent(Intent.ACTION_VIEW, Uri.parse("https://tv.naver.com/v/3074877"))
            startActivity(intent)
            overridePendingTransition(R.anim.slide_right_enter, R.anim.slide_right_exit)
        }

        viewMore.setOnClickListener {
            val movieSummary = getString(R.string.detail_page_summary_movie6)
